public class Raise {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 15; i++) {
            System.out.println("1.5^" + i + "=" + recRaiseOne(1.5, i) + ", Antal rekursioner = " + Raise.c1);
        }
        System.out.println(" ");
        System.out.println("Använder recRaiseHalf:");
        for (int i = 1; i <= 15; i++) {
            System.out.println("1.5^" + i + "=" + recRaiseHalf(1.5, i) + ", Antal rekursioner = " + Raise.c2);
        } */
